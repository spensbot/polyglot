...
- Change Struggling to learning. Add known words. Learning words don't count as known.
  - Add x number of times the users needs to see the word without a hint before it's no longer classified as learning
